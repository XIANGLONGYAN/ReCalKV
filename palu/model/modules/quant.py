...
# Standard quantizer, extended with a 1-bit implementation
@torch.no_grad()
...
class Quantizer(nn.Module):
    ...
    def forward(self, x):
        ...
        # Bind the last 4 args of quantize_tensor so qFunction only takes w
        qFunction = partial(
            quantize_tensor, 
            n_bits=self.n_bits,
        ...
        savedShape = x.shape
        # reshape x to 2D to handle a possible batch dimension
